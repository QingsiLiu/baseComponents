...
func TestFormatNew(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"error\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestFormatNew\n" +
...
func TestFormatErrorf(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"error\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestFormatErrorf\n" +
...
func TestFormatWrap(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"error\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestFormatWrap\n" +
...
func TestFormatWrapf(t *testing.T) {
	tests := []struct {
		...
		"EOF\n" +
			"error2\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestFormatWrapf\n" +
...
func TestFormatWithStack(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		[]string{"EOF",
			"github.com/QingsiLiu/baseComponents/errors.TestFormatWithStack\n" +
...
func TestFormatWithMessage(t *testing.T) {
	tests := []struct {
		...
		[]string{
			"error",
			"github.com/QingsiLiu/baseComponents/errors.TestFormatWithMessage\n" +
...
func TestFormatGeneric(t *testing.T) {
	starts := []struct {
		...
		{New("new-error"), []string{
			"new-error",
			"github.com/QingsiLiu/baseComponents/errors.TestFormatGeneric\n" +
	...
	wrappers := []wrapper{
		{
			...
			[]string{
				"github.com/QingsiLiu/baseComponents/errors.(func·002|TestFormatGeneric.func2)\n\t" +
			...
			[]string{
				"wrap-error",
				"github.com/QingsiLiu/baseComponents/errors.(func·003|TestFormatGeneric.func3)\n\t" +
			...
			[]string{
				"wrapf-error1",
				"github.com/QingsiLiu/baseComponents/errors.(func·004|TestFormatGeneric.func4)\n\t" +
...
func TestFormatWrappedNew(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"error\n" +
			"github.com/QingsiLiu/baseComponents/errors.wrappedNew\n" +
			"\t.+/errors/format_test.go:364\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestFormatWrappedNew\n" +
...
func TestFormatCode(t *testing.T) {
	tests := []struct {
		...
		{"%#-v", `[{\"caller\":\"#3 /home/lk/workspace/golang/src/errors/mocks_test.go:34 (github.com/QingsiLiu/baseComponents/errors.loadConfig)\",\"code\":1000,\"error\":\"service configuration could not be loaded\",\"message\":\"ConfigurationNotValid error\"}]`},
		{"%#+v", `[{\"caller\":\"#3 /home/lk/workspace/golang/src/errors/mocks_test.go:34 (github.com/QingsiLiu/baseComponents/errors.loadConfig)\",\"code\":1000,\"error\":\"service configuration could not be loaded\",\"message\":\"ConfigurationNotValid error\"},{\"caller\":\"#2 /home/lk/workspace/golang/src/errors/mocks_test.go:39 (github.com/QingsiLiu/baseComponents/errors.decodeConfig)\",\"code\":1001,\"error\":\"could not decode configuration data\",\"message\":\"Data is not valid JSON\"},{\"caller\":\"#1 /home/lk/workspace/golang/src/errors/mocks_test.go:39 (github.com/QingsiLiu/baseComponents/errors.readConfig)\",\"code\":1002,\"error\":\"could not read configuration file\",\"message\":\"End of input\"},{\"caller\":\"#0\",\"code\":1,\"error\":\"read: end of input\",\"message\":\"read: end of input\"}]`},
	}
