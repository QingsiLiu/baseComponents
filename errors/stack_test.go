...
func TestFrameFormat(t *testing.T) {
	var tests = []struct {
		...
		initpc,
		"%+s",
		"github.com/QingsiLiu/baseComponents/errors.init\n" +
...
func TestFuncname(t *testing.T) {
	tests := []struct {
		...
		{"", ""},
		{"runtime.main", "main"},
		{"github.com/QingsiLiu/baseComponents/errors.funcname", "funcname"},
		{"funcname", "funcname"},
...
func TestStackTrace(t *testing.T) {
	tests := []struct {
		...
		New("ooh"), []string{
			"github.com/QingsiLiu/baseComponents/errors.TestStackTrace\n" +
		...
		func() error { return New("ooh") }(), []string{
			`github.com/QingsiLiu/baseComponents/errors.TestStackTrace.func1` +
		...
		Cause(func() error {
			...
			`github.com/QingsiLiu/baseComponents/errors.TestStackTrace(\.TestStackTrace)?\.func2(\.1|\.func3)` +
				"\n\t.+/errors/stack_test.go:145", // this is the stack of Errorf
			`github.com/QingsiLiu/baseComponents/errors.TestStackTrace.func2` +
...
func TestStackTraceFormat(t *testing.T) {
	tests := []struct {
		...
		"%+v",
		"\n" +
			"github.com/QingsiLiu/baseComponents/errors.stackTrace\n" +
			"\t.+/errors/stack_test.go:174\n" +
			"github.com/QingsiLiu/baseComponents/errors.TestStackTraceFormat\n" +
